...
namespace RentospectMobileApp.Services
{
    public class MasterSyncService
    {
        ...
        public async Task SyncAllData(int userId, int companyId)
        {
            ...
            List<InspectionType> inspectionTypes = masterData.InspectionTypes.Select(insType => new InspectionType()
            {
                ...
                Name = insType.Name,
                RecommendationMessage = insType.RecommendationMessage
            }).ToList();
            ...
            //InspectionTypes
            await _db.DeleteAllAsync<InspectionType>();
            await _db.InsertAllAsync(inspectionTypes);
        }
    }
}
